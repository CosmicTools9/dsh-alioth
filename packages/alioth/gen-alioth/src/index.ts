...
export { generateApp, generateModule, generateExtensions, generateExtension, generateService, generateNamespaceWorkspace, generateServiceCrate, sourceModuleDirs, sourceServiceDirs, EXTENSION_FILES, type AppSpec, type GeneratedApp, type ModuleSpec, type NavigationGroup, type ServiceSpec, type ServiceEntitySpec } from './generate.ts'
