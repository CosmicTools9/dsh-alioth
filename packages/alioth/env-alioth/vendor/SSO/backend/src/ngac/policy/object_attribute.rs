...
/// Object attribute node aligned with ngac_object_attribute schema
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ObjectAttributeNode {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ObjectAttributeGraph {
    pub nodes: Vec<ObjectAttributeNode>,
}

impl ObjectAttributeGraph {
    pub fn new() -> Self {
        Self { nodes: vec![] }
    }

    pub fn add_node(&mut self, node: ObjectAttributeNode) {
...
impl Default for ObjectAttributeGraph {
    fn default() -> Self {
        Self::new()
    }
}
