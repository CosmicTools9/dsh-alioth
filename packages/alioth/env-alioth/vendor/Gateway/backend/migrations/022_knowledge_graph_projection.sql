...
AS $fn$
DECLARE
    lbl_node integer := ag_catalog._label_id('isahl_knowledge'::name, 'Node'::name)::integer;
    lbl_parent integer := ag_catalog._label_id('isahl_knowledge'::name, 'PARENT'::name)::integer;
    lbl_prev integer := ag_catalog._label_id('isahl_knowledge'::name, 'PREVIOUS'::name)::integer;
    lbl_bl integer := ag_catalog._label_id('isahl_knowledge'::name, 'BRIDGE_LAW'::name)::integer;
    lbl_br integer := ag_catalog._label_id('isahl_knowledge'::name, 'BRIDGE_REFERENCE'::name)::integer;
    lbl_bf integer := ag_catalog._label_id('isahl_knowledge'::name, 'BRIDGE_FORMULA'::name)::integer;
    lbl_rel integer := ag_catalog._label_id('isahl_knowledge'::name, 'REL'::name)::integer;
    max_rnk bigint;
BEGIN
