...
pub static STATEMENT_LEAVES: &[ScopeItemMeta] = &[
    ...
    ScopeItemMeta {
        table: "zc_id_orde-payment",
        concept: Some("订单-支付结算"),
    },
    ScopeItemMeta {
    ...
    ScopeItemMeta {
        table: "zc_id_order-after_sales",
        concept: Some("订单-售后服务"),
    },
    ScopeItemMeta {
...
pub fn statement_leaf_insert_sql(leaf: &str) -> Option<&'static str> {
    match leaf {
        ...
        "zc_id_stat-tsk-make" => Some(
            r#"INSERT INTO isahl."zc_id_stat-tsk-make" (notice, code, tpl_id, created_by_id, _f_, _t_, dk_scene, dk_factor, dk_function) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id"#,
        ),
        ...
        "zc_id_orde-payment" => Some(
            r#"INSERT INTO isahl."zc_id_orde-payment" (notice, code, tpl_id, created_by_id, _f_, _t_, dk_scene, dk_factor, dk_function) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id"#,
        ),
        ...
        "zc_id_order-after_sales" => Some(
            r#"INSERT INTO isahl."zc_id_order-after_sales" (notice, code, tpl_id, created_by_id, _f_, _t_, dk_scene, dk_factor, dk_function) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id"#,
        ),
...
pub fn task_leaf_insert_sql(leaf: &str) -> Option<&'static str> {
    match leaf {
        ...
        "zc_id_task-pay" => Some(
            r#"INSERT INTO isahl."zc_id_task-pay" (notice, code, tpl_id, created_by_id, _f_, _t_, dk_scene, dk_factor, dk_function) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id"#,
        ),
...
pub fn entity_row_sql(leaf: &str) -> Option<&'static str> {
    match leaf {
        ...
        "zc_id_task-pay" => {
            Some(r#"SELECT to_jsonb(t) FROM isahl."zc_id_task-pay" t WHERE t.id = $1"#)
        }
        "zc_id_task-storage" => {
