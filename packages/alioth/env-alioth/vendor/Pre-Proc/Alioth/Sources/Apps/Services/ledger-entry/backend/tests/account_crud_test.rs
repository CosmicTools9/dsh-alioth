//! Account CRUD 集成测试（#[tokio::test] + connect_test_db()，禁 sqlx::test 宏）
mod common;

use ::common::testing::connect_test_db;
use alioth_service_ledger_entry::models::{CreateAccountRequest, UpdateAccountRequest};
use alioth_service_ledger_entry::repositories::account_repository::AccountRepository;
