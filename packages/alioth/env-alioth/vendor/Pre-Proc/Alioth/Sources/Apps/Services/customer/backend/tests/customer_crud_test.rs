//! Customer CRUD 集成测试（#[tokio::test] + connect_test_db()，禁 sqlx::test 宏）
mod common;

use ::common::testing::connect_test_db;
use alioth_service_customer::models::{CreateCustomerRequest, UpdateCustomerRequest};
use alioth_service_customer::repositories::customer_repository::CustomerRepository;
